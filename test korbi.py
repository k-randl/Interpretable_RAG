...
query =  "As a consumer interested in food safety, can you elaborate on the essential control measures that food establishments should implement to manage foodborne illness risk factors, and how regulatory authorities assess these measures during inspections?"
contexts = [
    "Maria Skłodowska, later known as Marie Curie, was born on November 7, 1867.",
    "Born in Paris on 15 May 1859, Pierre Curie was the son of Eugène Curie, a doctor of French Catholic origin from Alsace.",
    "Maria Skłodowska was born in Warsaw, in Congress Poland in the Russian Empire, as the fifth and youngest child of well-known teachers Bronisława, née Boguska, and Władysław Skłodowski.",
...
#%%
query = queries[0]
contexts = contexts_topfive[0]  # Example contexts for the i-th query
