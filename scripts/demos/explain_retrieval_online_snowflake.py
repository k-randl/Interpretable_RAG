...
# Create RAG model:
retriever('query: ' + query, contexts=contexts, output_attentions=True, output_hidden_states=True)
...
higlight_importance_retriever(retriever, method='lime', token_processor=lambda s: s.replace('▁', ' '))