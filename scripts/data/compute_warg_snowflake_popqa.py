...
scorer = WARGScorer('../../data/popqa/snowflake-arctic-embed-l-v2.0/',
...
for p in range(1,10):
    warg[f'p={p*.1:0.2f}'] = scorer(warg['query'].tolist(), k=10, p=p*.1, batch_size=24,
                                    ...
                                    checkpoint_path='../../results/snowflake-arctic-embed-l-v2.0/scorer_popqa.json')
warg['passages'] = [scorer._queries[q][2] for q in warg['query'].tolist()]
warg.to_csv('../../results/snowflake-arctic-embed-l-v2.0/warg_popqa.csv', index=False)